...
UniValue getnewaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"getnewaddress",
               ...
               RPCResult{
                       RPCResult::Type::STR, "address", "The new keymaker address"
               },
               RPCExamples{
    ...
    RPCHelpMan{"setlabel",
               "\nSets the label associated with the given address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The keymaker address to be associated with a label."},
...
UniValue sendtoaddress(const JSONRPCRequest &request) {
    ...
    RPCHelpMan{"sendtoaddress",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Keymaker address to send to."},
                       ...
                       {"subtractfeefromamount", RPCArg::Type::BOOL, /* default */ "false",
                        ...
                        "                             The recipient will receive less amount of KEYM than you enter in the amount field."},
                               ...
                               {RPCResult::Type::ARR, "", "",
                                {
                                        {RPCResult::Type::ARR, "", "",
                                         {
                                                 {RPCResult::Type::STR, "address", "The keymaker address"},
...
UniValue listaddressbalances(const JSONRPCRequest &request) {
    RPCHelpMan{"listaddressbalances",
               ...
               RPCResult{
                       ...
                       {
                               {RPCResult::Type::STR_AMOUNT, "amount",
                                "The keymaker address and the amount in " + CURRENCY_UNIT},
                       }
               },
               RPCExamples{
...
UniValue signmessage(const JSONRPCRequest &request) {
    RPCHelpMan{"signmessage",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Keymaker address to use for the private key."},
...
UniValue getreceivedbyaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"getreceivedbyaddress",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Keymaker address for transactions."},
    ...
    RPCHelpMan{"sendmany",
               ...
               HELP_REQUIRING_PASSPHRASE,
               {
                       ...
                       {"amounts", RPCArg::Type::OBJ, RPCArg::Optional::NO, "A json object with addresses and amounts",
                        {
                                {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO,
                                 "The Keymaker address is the key, the numeric amount (can be string) in " +
                       ...
                       {"subtractfeefrom", RPCArg::Type::ARR, RPCArg::Optional::OMITTED_NAMED_ARG,
                        ...
                        "                           Those recipients will receive less KEYMs than you enter in their corresponding amount field.\n"
    ...
    RPCHelpMan{"addmultisigaddress",
               ...
               "If 'label' is specified, assign address to that label.\n",
               {
                       ...
                       {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO,
                        "A json array of keymaker addresses or hex-encoded public keys",
                        {
                                {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED,
                                 "keymaker address or hex-encoded public key"},
                        },
                       },
                               ...
                               {RPCResult::Type::OBJ, "", "", Cat(Cat < std::vector < RPCResult >> (
                                                                          {
                                                                              ...
                                                                              {
                                                                                  RPCResult::Type::STR, "address", "The keymaker address of the transaction. Not present for\n"
                               ...
                               {RPCResult::Type::ARR, "transactions", "",
                                {
                                        {RPCResult::Type::OBJ, "", "", Cat(Cat < std::vector < RPCResult >> (
                                                                                   {
                                                                                       { RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction" },
                                                                                       { RPCResult::Type::STR, "address", "The keymaker address of the transaction. Not present for move transactions (category = move)." },
                                        ...
                                        {RPCResult::Type::OBJ, "", "",
                                         {
                                                 ...
                                                 {RPCResult::Type::STR, "address",
                                                  "The keymaker address involved in the transaction."},
...
UniValue lockunspent(const JSONRPCRequest &request) {
    RPCHelpMan{"lockunspent",
               ...
               "A locked transaction output will not be chosen by automatic coin selection, when spending keymaker.\n"
...
static UniValue loadwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"loadwallet",
               ...
               "\nNote that all wallet command-line options used when starting keymakerd will be"
    ...
    RPCHelpMan{"listunspent",
               ...
               "Optionally filter to only include txouts paid to specified addresses.\n",
               {
                       ...
                       {"addresses", RPCArg::Type::ARR, /* default */ "empty array",
                        "A json array of keymaker addresses to filter",
                        {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "keymaker address"},
                        },
                       },
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY,
                                   std::string("Invalid Keymaker address: ") + input.get_str());
            }
                       ...
                       {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG,
                        "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                                {"changeAddress", RPCArg::Type::STR, /* default */ "pool address",
                                 "The Keymaker address to receive the change"},
                                ...
                                {"subtractFeeFromOutputs", RPCArg::Type::ARR, /* default */ "empty array",
                                 ...
                                 "                              Those recipients will receive less KEYM than you enter in their corresponding amount field.\n"
...
UniValue getaddressinfo(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressinfo",
               "\nReturn information about the given keymaker address. Some information requires the address\n"
               "to be in the wallet.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The keymaker address to get the information of."},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
                               {RPCResult::Type::STR, "address", "The keymaker address validated."},
...
UniValue impokeymulti(const JSONRPCRequest &request);
...
static const CRPCCommand commands[] =
        { //  category              name                        actor (function)           argNames
                ...
                {"wallet",          "impokeymulti",                  &impokeymulti,                  {"requests",       "options"}},
