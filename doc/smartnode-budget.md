...
Keymaker now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ KEYMAKER, _12_ times over the course of a year totaling _24000_ KEYMAKER.

**Warning: if you change any fields within this command, the collateral transaction will become invalid.**

Format: ```mngovernance prepare proposal-name url payment-count block-start keymaker-address monthly-payment-keymaker```
...
Format: ```mngovernance submit proposal-name url payment-count block-start keymaker-address monthly-payment-keymaker fee-tx```
...
"main" : {
        ...
        "Hash" : "6e8bkeymaker5113de592f6888f200f146448440b7e606fcf62ef84e60e1d5ac7d64",
        "BlockStart" : 100000,
        "BlockEnd" : 100000,
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` KEYMAKER to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single smartnode (using keymaker.conf setup)
